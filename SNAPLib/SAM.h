...
public:
    ...
    virtual bool write(Read *read, AlignmentResult result, unsigned genomeLocation, bool isRC, bool isTranscriptome, char flag) = 0;
...
public:
    ...
    virtual bool write(Read *read, AlignmentResult result, unsigned genomeLocation, bool isRC, bool isTranscriptome, char flag);
...
private:
    ...
    void write(Read *read, AlignmentResult result, unsigned genomeLocation, bool isRC, bool isTranscriptome, char flag, bool hasMate, bool firstInPair,
               Read *mate, AlignmentResult mateResult, unsigned mateLocation, bool mateIsRC, bool mateIsTranscriptome, char mateFlag);
...
public:
    ...
    bool write(Read *read, AlignmentResult result, unsigned genomeLocation, bool isRC, bool isTranscriptome, char flag);
